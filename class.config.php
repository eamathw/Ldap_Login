...
class Config
{
    ...
    private $default_val = [
        ...
        'ld_azure_auth_url'               => 'https://login.microsoftonline.com/{TENANT_ID}/oauth2/v2.0/authorize',
        'ld_azure_scopes'                 => 'openid profile User.Read email',
        'ld_azure_token_url'              => 'https://login.microsoftonline.com/{TENANT_ID}/oauth2/v2.0/token',
        'ld_azure_resource_url'           => 'https://graph.microsoft.com/v1.0/me?$select=userPrincipalName,mail',
        'ld_azure_logout_url'             => null,
        'ld_azure_user_identifier'        => 'userPrincipalName',
        'ld_azure_client_id'              => null,
        'ld_azure_client_secret'          => null,
        'ld_azure_jwks_url'               => 'https://login.microsoftonline.com/{TENANT_ID}/discovery/keys',
        'ld_azure_tenant_id'              => null,
        'ld_azure_redirect_uri'           => 'https://your_piwigo_url/admin.php?page=plugin&section=Ldap_Login/azure/callback.php',
